...
public class CategoriaService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Não é possível excluir o objeto: [" + Categoria.class.getName() + "] pois possui entidades relacionadas.");
		}
	}
	...
	public Page<Categoria> pagination(Integer pageNumber, Integer pageSize, String orderBy, String direction) {
